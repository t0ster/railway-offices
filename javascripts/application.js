...
(function() {
  var TICKET_OFFICES, placemark;

  TICKET_OFFICES = [["Аэропорт Борисполь", "ежед 8.00 - 19.30 обед 13.00 - 14.00"], ["ул. Предславенская, 49", "ежед. 9.00 - 18.00 обед 14.00 - 15.00 сб, вс. - Выходной"], ["пр-кт Голосеевский, 102 / 1", "ежед. 9.00 - 17.00 обед 14.00 - 14.30 сб, вс. - Выходной"], ["ул. Большая Васильковская, 66-Б", "ежед. 9.00 - 18.00 обед 13.00 - 14.00 сб, вс. - Выходной"], ["ул. Большая Васильковская, 84/20", "ежед. 9.00 - 17.30 обед 14.00 - 15.00 сб, вс. - Выходной"]];

  placemark = function(address, desc) {
    var geocoder;
  ...
  $(function() {
    var address, desc, map, _i, _len, _ref;
    ...
    for (_i = 0, _len = TICKET_OFFICES.length; _i < _len; _i++) {
      _ref = TICKET_OFFICES[_i], address = _ref[0], desc = _ref[1];
